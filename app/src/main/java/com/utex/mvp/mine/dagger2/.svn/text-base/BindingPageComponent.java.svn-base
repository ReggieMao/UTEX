 ...
 */
@ActivityScope
@Component(modules = BindingPageModule.class, dependencies = AppComponent.class)
public interface BindingPageComponent extends BaseComponent<BindingPageActivity, IBindingPagePresenter> {
