...
public class PictureShowPopupWindow {
    ...
    public PictureShowPopupWindow(Context context, int parentLayoutRes) {
        this.context = context;
        this.parentLayoutRes = parentLayoutRes;
        initPopupWindow(R.layout.view_picture_show);
    }
    ...
    public void show() {
        try {
            ...
            popupWindow.showAtLocation(LayoutInflater.from(context).inflate(parentLayoutRes, null), Gravity.CENTER, 0, 0);
        } catch (Exception e) {
