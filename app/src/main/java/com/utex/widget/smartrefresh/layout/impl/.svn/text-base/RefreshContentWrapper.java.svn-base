package com.utex.widget.smartrefresh.layout.impl;
...
import com.utex.widget.smartrefresh.layout.listener.CoordinatorLayoutListener;
import com.utex.widget.smartrefresh.layout.util.DesignUtil;
...
import static com.utex.widget.smartrefresh.layout.util.ScrollBoundaryUtil.canScrollDown;
import static com.utex.widget.smartrefresh.layout.util.ScrollBoundaryUtil.canScrollUp;
import static com.utex.widget.smartrefresh.layout.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static com.utex.widget.smartrefresh.layout.util.SmartUtil.isContentView;
import static com.utex.widget.smartrefresh.layout.util.SmartUtil.measureViewHeight;
import static com.utex.widget.smartrefresh.layout.util.SmartUtil.scrollListBy;
