package com.utex.widget.smartrefresh.layout.header;
...
import com.utex.widget.smartrefresh.layout.internal.ArrowDrawable;
import com.utex.widget.smartrefresh.layout.internal.InternalClassics;
import com.utex.widget.smartrefresh.layout.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        REFRESH_HEADER_PULLING = Utils.getResourceString(R.string.srl_header_pulling);
        REFRESH_HEADER_REFRESHING = Utils.getResourceString(R.string.srl_header_refreshing);
        REFRESH_HEADER_LOADING = Utils.getResourceString(R.string.srl_header_loading);
        REFRESH_HEADER_RELEASE = Utils.getResourceString(R.string.srl_header_release);
        REFRESH_HEADER_FINISH = Utils.getResourceString(R.string.srl_header_finish);
        REFRESH_HEADER_FAILED = Utils.getResourceString(R.string.srl_header_failed);
        REFRESH_HEADER_UPDATE = Utils.getResourceString(R.string.srl_header_update);
        REFRESH_HEADER_SECONDARY = Utils.getResourceString(R.string.srl_header_secondary);
