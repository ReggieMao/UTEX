 ...
 */
public class UTEXLockerLinkedLineView implements ILockerLinkedLineView {
    ...
    public UTEXLockerLinkedLineView() {
    ...
    public UTEXLockerLinkedLineView setNormalColor(int normalColor) {
    ...
    public UTEXLockerLinkedLineView setErrorColor(int errorColor) {
    ...
    public UTEXLockerLinkedLineView setLineWidth(float lineWidth) {
